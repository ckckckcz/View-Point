...
const Home = () => {
    return(
        <>
            <section className="bg-center bg-no-repeat bg-cover bg-[url('https://cdn.pixabay.com/photo/2016/09/12/20/44/horse-race-1665688_960_720.jpg')] bg-gray-700 bg-blend-multiply lg:h-screen lg:w-screen h-[600px] flex items-center justify-center">
